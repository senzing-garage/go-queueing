...
More information at https://github.com/senzing/go-queueing
...
More information can be found in the [pkg/github.com/senzing/go-queueing/examplepackage] documentation.
...
Examples of use can be seen in the main_test.go files.
	...
	import (
	    ...
	    "github.com/senzing/go-queueing/examplepackage"
	    "github.com/senzing/go-queueing/anotherpackage"
	)
